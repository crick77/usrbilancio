...
public class Keys {
    ...
    public static final UniqueKey<CodiceRecord> KEY_CODICE_CODICE_CXX_UNQ = Internal.createUniqueKey(Codice.CODICE, DSL.name("KEY_codice_codice_cxx_unq"), new TableField[] { Codice.CODICE.ID_CONTABILITA, Codice.CODICE.CODICE_, Codice.CODICE.C01, Codice.CODICE.C02, Codice.CODICE.C04, Codice.CODICE.C03, Codice.CODICE.C05 }, true);
    ...
    public static final UniqueKey<CodiciTributoRecord> KEY_CODICI_TRIBUTO_PRIMARY = Internal.createUniqueKey(CodiciTributo.CODICI_TRIBUTO, DSL.name("KEY_codici_tributo_PRIMARY"), new TableField[] { CodiciTributo.CODICI_TRIBUTO.CODICE }, true);
    ...
    public static final UniqueKey<ComuneRecord> KEY_COMUNE_PRIMARY = Internal.createUniqueKey(Comune.COMUNE, DSL.name("KEY_comune_PRIMARY"), new TableField[] { Comune.COMUNE.COD_CATASTALE }, true);
    public static final UniqueKey<ContabilitaRecord> KEY_CONTABILITA_NUMERO_UNIQUE = Internal.createUniqueKey(Contabilita.CONTABILITA, DSL.name("KEY_contabilita_numero_UNIQUE"), new TableField[] { Contabilita.CONTABILITA.NUMERO }, true);
    public static final UniqueKey<ContabilitaRecord> KEY_CONTABILITA_PRIMARY = Internal.createUniqueKey(Contabilita.CONTABILITA, DSL.name("KEY_contabilita_PRIMARY"), new TableField[] { Contabilita.CONTABILITA.ID }, true);
    ...
    public static final UniqueKey<RitenutaRecord> KEY_RITENUTA_PRIMARY = Internal.createUniqueKey(Ritenuta.RITENUTA, DSL.name("KEY_ritenuta_PRIMARY"), new TableField[] { Ritenuta.RITENUTA.ID }, true);
    ...
    public static final ForeignKey<CapitoloRecord, ContabilitaRecord> FK_CAPITOLO_CONTABILITA = Internal.createForeignKey(Capitolo.CAPITOLO, DSL.name("fk_capitolo_contabilita"), new TableField[] { Capitolo.CAPITOLO.ID_CONTABILITA }, Keys.KEY_CONTABILITA_PRIMARY, new TableField[] { Contabilita.CONTABILITA.ID }, true);
    public static final ForeignKey<CodiceRecord, ContabilitaRecord> FK_CODICE_CONTABILITA = Internal.createForeignKey(Codice.CODICE, DSL.name("fk_codice_contabilita"), new TableField[] { Codice.CODICE.ID_CONTABILITA }, Keys.KEY_CONTABILITA_PRIMARY, new TableField[] { Contabilita.CONTABILITA.ID }, true);
    ...
    public static final ForeignKey<OrdinativoAppoggioRecord, ContabilitaRecord> FK_ORDINATIVOAPP_CONTABILITA = Internal.createForeignKey(OrdinativoAppoggio.ORDINATIVO_APPOGGIO, DSL.name("fk_ordinativoapp_contabilita"), new TableField[] { OrdinativoAppoggio.ORDINATIVO_APPOGGIO.ID_CONTABILITA }, Keys.KEY_CONTABILITA_PRIMARY, new TableField[] { Contabilita.CONTABILITA.ID }, true);
    ...
    public static final ForeignKey<RettificaIvaRecord, ContabilitaRecord> FK_RETTIFICAIVA_CONTABILITA = Internal.createForeignKey(RettificaIva.RETTIFICA_IVA, DSL.name("fk_rettificaiva_contabilita"), new TableField[] { RettificaIva.RETTIFICA_IVA.ID_CONTABILITA }, Keys.KEY_CONTABILITA_PRIMARY, new TableField[] { Contabilita.CONTABILITA.ID }, true);
    ...
    public static final ForeignKey<RitenutaRecord, AnagraficaRecord> FK_RITENUTA_ANAGRAFICA = Internal.createForeignKey(Ritenuta.RITENUTA, DSL.name("fk_ritenuta_anagrafica"), new TableField[] { Ritenuta.RITENUTA.ID_ANAGRAFICA }, Keys.KEY_ANAGRAFICA_PRIMARY, new TableField[] { Anagrafica.ANAGRAFICA.ID }, true);
    public static final ForeignKey<RitenutaRecord, OrdinativoRecord> FK_RITENUTA_ORDINATIVO = Internal.createForeignKey(Ritenuta.RITENUTA, DSL.name("fk_ritenuta_ordinativo"), new TableField[] { Ritenuta.RITENUTA.ID_ORDINATIVO }, Keys.KEY_ORDINATIVO_PRIMARY, new TableField[] { Ordinativo.ORDINATIVO.ID }, true);
}
