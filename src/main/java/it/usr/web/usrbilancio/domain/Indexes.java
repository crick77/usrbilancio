...
public class Indexes {
    ...
    public static final Index ORDINATIVO_APPOGGIO_FK_ORDINATIVOAPP_CONTABILITA_IDX = Internal.createIndex(DSL.name("fk_ordinativoapp_contabilita_idx"), OrdinativoAppoggio.ORDINATIVO_APPOGGIO, new OrderField[] { OrdinativoAppoggio.ORDINATIVO_APPOGGIO.ID_CONTABILITA }, false);
